...
contract ShitToken is ERC20('Shit Defi', 'SHTFI'), Ownable {
    ...
    // Maximum shit tokens which will ever exist
    ...
    function setFarm (address _farm) public onlyOwner {
        ...
        require(msg.sender != _farm, 'SHIT: Farm cannot be owner address');
        farmAddress = _farm;
    }
